...
abstract contract VRC725 is ERC165, IVRC725 {
    ...
    function permitForAll(
        ...
        require(deadline >= block.timestamp, "VRC725: Permit deadline expired");
        bytes32 digest = _getPermitForAllDigest(
            spender,
    ...
    function transferFrom(
        ...
        require(
            ...
            "VRC725: caller is not token owner or approved"
        );
    ...
    function _transfer(
        ...
        require(
            VRC725.ownerOf(tokenId) == from,
            "VRC725: transfer from incorrect owner"
        );
     ...
     * @param deadline a timestamp expiry for the permit
     */
    function _getPermitForAllDigest(
        address spender,
        uint256 nonce,
        uint256 deadline
    ) internal view returns (bytes32) {
    ...
    function acceptOwnership() external {
        require(
            ...
            "VRC725: only new owner can accept ownership"
        );
    ...
    function transferOwnership(address newOwner) external virtual onlyOwner {
        require(
            newOwner != address(0),
            "VRC725: new owner is the zero address"
        );
        _newOwner = newOwner;
    }
